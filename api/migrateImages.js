...
// Key tạm nhúng sẵn — dùng khi chưa vào được Vercel để đặt env MIGRATE_SECRET.
// Chỉ là cổng nhẹ cho tác vụ chạy 1 lần; XOÁ FILE NÀY ngay sau khi migrate xong.
const FALLBACK_SECRET = 'gdhaha-migrate-2026';

export default async function handler(req, res) {
  const secret = process.env.MIGRATE_SECRET || FALLBACK_SECRET;
